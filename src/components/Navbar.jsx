    ...
    <>
      ...
      <header className="md:hidden fixed inset-x-0 top-0 z-50">
        <div className="mx-auto max-w-screen px-3 py-2 flex items-center justify-between">
          <div className="rounded-full px-3 py-2 bg-white/90 bg-opacity-90 text-xs font-semibold text-[var(--color-burgundy)]">
            Menú
          </div>
          ...
          <button
            ...
            className="inline-flex items-center justify-center h-9 w-9 rounded-lg bg- shadow ring-1 ring-black/5 active:scale-95 transition"
          >
